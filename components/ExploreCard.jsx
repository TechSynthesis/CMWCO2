...
const ExploreCard = ({
  ...
  >
    ...
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 justify-start w-full h-[90%] xs:h-[70%] md:h-fit flex-col bg-[rgba(0,0,0,0.5)] rounded-b-xl">
        <div
          className={`${styles.flexCenter} w-[60px] h-[60px] rounded-xl glassmorphism mb-[16px]`}
        >
          {/* <img
            src="/headset.svg"
            alt="headset/icon"
